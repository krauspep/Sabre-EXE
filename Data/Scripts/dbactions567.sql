ALTER PROCEDURE CREATE_DUTY_SCHEDULE (
    ...
    SELECT WS.WORK_SCHEDULE_KEY,
      ...
      FROM EMPLOYEE E 
           ...
           JOIN SHIFT_ASSIGN_WEEK SAW ON SAW.SHIFT_KEY = S.SHIFT_KEY AND 
                                         SAW.ASSIGNED_WEEK_NO = EXTRACT(WEEK FROM THEDATE) AND 
...
GRANT EXECUTE
 ON PROCEDURE CREATE_DUTY_SCHEDULE TO  SYSDBA;
